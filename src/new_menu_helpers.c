...
void AddTextPrinterDiffStyle(bool8 allowSkippingDelayWithButtonPress)
{
    ...
    else if (color == NPC_TEXT_COLOR_CREEPY)
        AddTextPrinterParameterized2(0, FONT_FEMALE, gStringVar4, GetTextSpeedSetting(), nptr, TEXT_COLOR_GREEN, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GREEN);
    else if (color == NPC_TEXT_COLOR_EVIL)
        AddTextPrinterParameterized2(0, FONT_MALE, gStringVar4, GetTextSpeedSetting(), nptr, TEXT_COLOR_DARK_GRAY, TEXT_COLOR_WHITE, TEXT_COLOR_RED);
