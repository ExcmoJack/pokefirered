...
const u8 gText_SaveFileHasBeenDeleted[] = _("¡Nueva versión disponible!\pPor favor, visita\nexcmojack.wordpress.com/\llavender-tales");
...
const u8 gText_LeagueChamp[] = _("Permanecerás conmigo…\n¡PARA SIEMPRE!");
...
const u8 gText_Multichoice_TengoOtraOpcion[] = _("¿Tengo otra opción?");
const u8 gText_Multichoice_Yes[] = _("Sí");
